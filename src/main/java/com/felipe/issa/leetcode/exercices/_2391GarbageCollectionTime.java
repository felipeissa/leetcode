...
public class _2391GarbageCollectionTime {
    ...
    public static void main(String[] args) {
        int time = new _2391GarbageCollectionTime().garbageCollection(new String[]{ "G", "P", "GP", "GG"}, new int[] {2, 4, 3});
        System.out.println("time is: " + time + ". should be 21");

        time = new _2391GarbageCollectionTime().garbageCollection(new String[]{ "MMM", "PGM", "GP" }, new int[] {3, 10});
        System.out.println("time is: " + time + ". should be 37");
    }
}
