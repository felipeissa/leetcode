...
public class _1424DiagonalTraverseII {
    ...
    public void firstCase() {
        ...
        assertArrayEquals(new int[]{1, 4, 2, 7, 5, 3, 8, 6, 9}, output);
    }
    ...
    public void secondCase() {
        ...
        assertArrayEquals(new int[]{1, 6, 2, 8, 7, 3, 9, 4, 12, 10, 5, 13, 11, 14, 15, 16}, output);
    }
    ...
    public void thirdCase() {
        ...
        assertArrayEquals(new int[]{14, 13, 12, 11, 14, 19, 13, 15, 16, 1, 8, 9, 11}, output);
    }
}
