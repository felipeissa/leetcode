...
public class _2147LongCorridorDP {
    ...
    public static void main(String[] args) {
        int output;
        int expected;
        output = new _2147LongCorridorDP().numberOfWays("SSPS");
        expected = 0;
        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));

//        output = new _2147LongCorridorDP().numberOfWays("PPSPSP");
//        expected = 1;
//        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));
//
//        output = new _2147LongCorridorDP().numberOfWays("SSPPSPS");
//        expected = 3;
//        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));
//
//        output = new _2147LongCorridorDP().numberOfWays("SPPSSSSPPS");
//        expected = 1;
//        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));
//
//        output = new _2147LongCorridorDP().numberOfWays("P");
//        expected = 0;
//        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));
//
//        output = new _2147LongCorridorDP().numberOfWays("PPPPPSPPSPPSPPPSPPPPSPPPPSPPPPSPPSPPPSPSPPPSPSPPPSPSPPPSPSPPPPSPPPPSPPPSPPSPPPPSPSPPPPSPSPPPPSPSPPPSPPSPPPPSPSPSS");
//        expected = 919999993;
//        System.out.println(MessageFormat.format("Is same: {0}, Expected: {1}, got: {2}", output == expected, expected, output));
    }
}
